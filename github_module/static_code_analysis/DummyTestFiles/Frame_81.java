...
public class Frame_81 extends JFrame {
                ...
                if (previousTabIndex != currentTabIndex) {
                    try {
                        ...
                        if (previousTabIndex != -1)
                            ((TabInterface) tabbedPane.getComponentAt(previousTabIndex)).stopSayingHi();
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        ((TabInterface) tabbedPane.getComponentAt(currentTabIndex)).startSayingHi();
                    } catch (Exception e) {
                        System.out.println(e);
                    }
    ...
    /**
     * The function adds all the tabs mentioned in the TAB_NAMES variable to the
     * passed tabbedPane
     * 
    ...
    /**
     * The function is to fix size formatting in all the panels containg names. This
     * is required as many students have given too big a size for their panels. The
     * function can be removed once all the child panels have been fixed.
     * 
     * @param tabPane name of the pane containing tabs
     */
